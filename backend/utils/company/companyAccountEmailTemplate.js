      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
        ...
        <tr>
          <td style="padding:12px 14px">
            ...
            <div style="font:600 14px/1.5 Arial, sans-serif;color:${brand.primary}">
              ${val}
            </div>
          </td>
        </tr>
    ...
    <tr>
      <td align="center" style="padding:28px 16px">
        <table role="presentation" width="680" cellpadding="0" cellspacing="0" border="0"
          ...
          <!-- Footer -->
          <tr>
            <td style="padding:16px 22px;background:#FAFAFA;border-top:1px solid ${brand.border}">
              <div style="font:400 12px/1.5 Arial, sans-serif;color:#9CA3AF">
