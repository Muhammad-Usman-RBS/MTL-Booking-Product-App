...
export const customerCancellationEmailTemplate = ({
  ...
  const org = {
    name:
      ...
      "Our Company",
    logoUrl:
      options.logoUrl || company.profileImage || clientAdmin.profileImage || "",
    email:
      options.supportEmail ||
      clientAdmin?.email ||
      company?.email ||
      "support@company.com",
    phone: options.supportPhone || clientAdmin?.phone || company?.contact || "",
              ...
              <table width="100%" role="presentation" style="padding:18px 22px">
                <tr>
                  ...
                  <td align="right" style="vertical-align:middle">
                    ...
                    <div style="font:400 13px/2 Arial,sans-serif;color:${
                      brand.muted
                    }">
                    ${
                      org.email
                        ? `<strong>Email:</strong> ${formatEmail(
                            safe(org.email)
                          )}<br/>`
                        : ""
                    }
          ...
          <tr>
            <td class="px-22" style="padding:24px 22px 18px;text-align:start">
              <div style="font:500 24px/1.3 Arial,sans-serif;color:${
                brand.primary
              };margin:0 0 10px">Your booking has been cancelled</div>
              <div style="font:600 16px/1.5 Arial,sans-serif;color:${
                brand.accent
              };margin:8px 0 0">Booking Reference: #${safe(
    booking.bookingId
  )}</div>
              <div style="font:400 14px/1.5 Arial,sans-serif;color:${
                brand.muted
              };margin-top:10px">
                Cancelled by ${safe(cancelledBy)}.
                ${
                  cancellationReason
                    ? `<br/><strong>Reason:</strong> ${safe(
                        cancellationReason
                      )}`
                    : ""
                }
          ...
          <tr>
            <td class="px-22" style="padding:0 22px 18px;">
              <table role="presentation" width="100%" style="border:1px solid ${
                ...
                <tr>
                  <td colspan="2" style="font:700 14px Arial,sans-serif;color:${
                    brand.primary
                  };padding-bottom:8px">Journey Details</td>
                </tr>
                <tr style="line-height:1.4;margin-bottom:6px;">
                  <td style="color:${
                    brand.muted
                  };vertical-align:top;font:600 13px Arial,sans-serif;margin-bottom:6px;"><div style="margin-bottom:10px;">From:</div></td>
                  <td style="color:${
                    brand.primary
                  };margin-bottom:6px;font:400 13px Arial,sans-serif"><div style="margin-bottom:10px;">${safe(
    pickup
  )}</div></td>
                </tr>
                <tr>
                  <td style="color:${
                    brand.muted
                  };vertical-align:top;font:600 13px Arial,sans-serif"><div style="margin-bottom:10px;">To:</div></td>
                  <td style="color:${
                    brand.primary
                  };font:400 13px Arial,sans-serif"><div style="margin-bottom:10px;">${safe(
    dropoff
  )}</div></td>
                </tr>
                <tr>
                  ...
                  <td style="color:${
                    brand.muted
                  };vertical-align:top;font:600 13px Arial,sans-serif;white-space:nowrap;"> <div style="margin-bottom:10px;">Date & Time:</div></td>
                  <td style="color:${
                    brand.primary
                  };font:400 13px Arial,sans-serif"> <div style="margin-bottom:10px;">${safe(
    journeyDateTime
    ...
    brand.border
                ...
                <tr>
                  <td style="font:400 14px/1.6 Arial,sans-serif;color:${
                    ...
                    <a href="mailto:${safe(org.email)}" style="color:${
    brand.accent
  };font-weight:600;text-decoration:none">Email Support</a>
                    ${
                      org.phone
                        ? `<br/><a href="tel:${safe(org.phone)}" style="color:${
                            brand.accent
                          };font-weight:600;text-decoration:none">Call +${safe(
                            org.phone
                          )}</a>`
                        : ""
                    }
              ...
              ${
                org.website
                  ? `<div style="margin-bottom:6px"><a href="${safe(
                      ...
                      brand.accent
                    };font-size:13px;text-decoration:none">${safe(
                      org.website
                    )}</a></div>`
                  : ""
              }
